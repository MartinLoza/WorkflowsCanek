...
dataFile <- here("Data/Results/Simulations")
```
...
## With batch-effects
sim2 <- splatter::splatSimulate(params, method = method_C3_C4_C5, group.prob = group.prob_C3_C4_C5, de.prob = group.prob_C3_C4_C5, seed = seed, verbose = FALSE)

## Without batch-effects
sim22 <- splatter::splatSimulate(params, method = method_C3_C4_C5, group.prob = c(0.4,0.3,0.3), de.prob = c(0.2,0.25,0.35), seed = seed, verbose = FALSE, batch.rmEffect = TRUE)
```
