...
dataFile <- here("Data/Results/Jurkat_293t") 
```
...
```{r}
Mix50_50 <- RNAseqAnalysis::SeuratPreprocessing(object = Mix50_50)
```
...
x <- Seurat::GetUMAP(x, dims = 10)
DimPlot(x, group.by = "batch") / DimPlot(x, group.by = "celltype")
```
# Save Datasets
